...
import { getMyGroups, getGroupMessages, uploadAttachment, getGroupStats, syncLegacyNodes, editMessage, shareDropToNode } from "../controllers/chat.controller.js";
...
router.post("/share-drop", shareDropToNode);
